        ...
        <div class="max-w-md w-full bg-white/90 backdrop-blur-lg shadow-2xl rounded-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('verification.send') }}">
                    @csrf
                    <button type="submit"
                        class="w-full bg-linear-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg hover:scale-105 transform transition-all shadow-lg font-semibold mb-4">
