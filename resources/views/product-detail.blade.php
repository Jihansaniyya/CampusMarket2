...
<section class="max-w-screen-2xl mx-auto w-full px-4 sm:px-6 lg:px-10 xl:px-12 py-10">
    ...
    <div class="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div class="flex items-center justify-center bg-gray-50 rounded-xl p-6">
            <img src="https://picsum.photos/500/500?random={{ $product->id }}" 
                alt="{{ $product->name }}" 
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-2">
                @if ($product->sale_price)
                    ...
                    <div class="text-4xl font-bold text-blue-600">Rp {{ number_format($product->sale_price, 0, ',', '.') }}</div>
                @else
                    <div class="text-4xl font-bold text-blue-600">Rp {{ number_format($product->price, 0, ',', '.') }}</div>
                @endif
            </div>
            ...
            <div class="flex gap-3 pt-4">
                <button class="flex-1 bg-blue-600 text-white rounded-lg py-3 font-semibold hover:bg-blue-500 transition">
                    Tambah ke Keranjang
                </button>
                <button class="px-6 py-3 border border-gray-300 rounded-lg font-semibold hover:border-gray-400 transition">
