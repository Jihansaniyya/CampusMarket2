...
@section('page-description')
    Halo, {{ Auth::user()->name }}! 👋 Berikut ringkasan performa tokomu.
@endsection
...
<div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 mb-8">
        <div class="flex items-center gap-3 mb-6">
            <div class="w-10 h-10 bg-linear-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="{{ route('seller.products.create') }}" class="group relative p-5 rounded-xl border-2 bg-blue-50 hover:border-blue-400 transition">
            ...
            <a href="{{ route('seller.products.index') }}" class="group relative p-5 rounded-xl border-2 bg-indigo-50 hover:border-indigo-400 transition">
                <div class="w-14 h-14 bg-white shadow-md rounded-xl flex items-center justify-center">
            ...
            <a href="{{ route('seller.orders.index') }}" class="group relative p-5 rounded-xl border-2 bg-emerald-50 hover:border-emerald-400 transition">
                <div class="w-14 h-14 bg-white shadow-md rounded-xl flex items-center justify-center">
