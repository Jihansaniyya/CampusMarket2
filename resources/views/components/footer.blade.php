            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:support@campusmarket.id"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-gray-500 text-sm text-center md:text-left">
                    © {{ date('Y') }} <span class="text-blue-500 font-semibold">CampusMarket</span>. All rights
                    reserved.
                </p>
                <div class="flex items-center gap-6">
                    <a href="{{ route('terms.seller') }}"
                        class="text-gray-500 hover:text-white text-sm transition-colors">Syarat & Ketentuan</a>
                    <a href="{{ route('privacy.policy') }}"
                        class="text-gray-500 hover:text-white text-sm transition-colors">Kebijakan Privasi</a>
                </div>
            </div>
        </div>
    </div>
