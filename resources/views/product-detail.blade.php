...
@section('content')
    <section class="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <a href="{{ route('product.search', ['category_id' => $product->category_id]) }}" class="hover:text-gray-800 transition-colors">
            ...
            <div class="grid lg:grid-cols-5 gap-0">
                ...
                <div class="lg:col-span-2 p-6 lg:p-8">
                    <div class="aspect-square rounded-xl overflow-hidden bg-gray-50">
                        <img src="{{ $product->thumbnail ? asset('storage/' . $product->thumbnail) : 'https://placehold.co/500x500/f8fafc/64748b?text=' . urlencode(substr($product->name, 0, 15)) }}"
                            alt="{{ $product->name }}" 
                ...
                <div class="lg:col-span-3 p-6 lg:p-8 lg:border-l border-gray-100">
                    ...
                    <div class="flex items-center gap-2 mb-6 pb-6 border-b border-gray-100">
                        @if ($product->stock > 0)
                            <span class="inline-flex items-center gap-1.5 text-sm text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div class="w-11 h-11 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-sm">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl border border-gray-100 p-5 sticky top-24">
                        ...
                        <form action="{{ route('product.review.store') }}" method="POST" class="space-y-4">
                            ...
                            <!-- Email -->
                            <div>
                                <label class="block text-sm text-gray-600 mb-1.5">Email <span class="text-gray-400">(opsional)</span></label>
                            ...
                            <!-- Comment -->
                            <div>
                                <label class="block text-sm text-gray-600 mb-1.5">Ulasan <span class="text-gray-400">(opsional)</span></label>
                    ...
                    @forelse($product->reviews as $review)
                        <div class="bg-white rounded-xl border border-gray-100 p-5">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center">
