...
<header>
    ...
    <p class="meta">Keterangan: Produk diurutkan berdasarkan stok dari yang terbanyak ke yang terkecil.</p>
</header>
...
<table>
    ...
    @forelse ($products as $index => $product)
        @php
            // Normalisasi nama kategori dari berbagai kemungkinan kolom
            $kategori = null;
